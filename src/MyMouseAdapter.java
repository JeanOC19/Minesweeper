...
while(myPanel.colorArray[i][myPanel.mouseDownGridY].equals(newColor) || newColor == null) {
...
while(myPanel.colorArray[myPanel.mouseDownGridX][i].equals(newColor) || newColor == null) {
...
while(myPanel.colorArray[i][i].equals(newColor) || newColor == null) {
...
while(myPanel.colorArray[i][j].equals(newColor) || newColor == null) {
